...
#source_folder = os.path.join(os.getcwd(), "images\deprati")
#json_path = "deprati.json"                     # Relative to root directory
source_folder = os.path.join(os.getcwd(), "images\etafashion")
json_path = "etafashion.json"                     # Relative to root directory
